...
clf_baseline = baseline_model.named_steps['clf']
print(f"\nTraining set loss: {clf_baseline.loss_:.4f}")
if clf_baseline.best_loss_ is not None:
    print(f"Best loss: {clf_baseline.best_loss_:.4f}")
else:
    print(f"Best loss: Not available (early stopping not triggered)")
...
# Define parameter grid with deeper architectures
param_grid = {
